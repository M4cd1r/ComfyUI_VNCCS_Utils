...
import { POSE_LAYER_TYPE, normalizePoseLayerData } from "../web/vnccs_unicanvas_pose_layers.mjs";
...
const context = {
  isImageLayer, serializePose, poseGenerationLayer, mergePoseCache, POSE_LAYER_TYPE, normalizePoseLayerData,
